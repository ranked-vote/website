...
<svelte:head>
  ...
  <meta property="og:image" content={"https://r.moxy.social/ykZcSLKZUq/approval/fb.png/" + path.join("/")} />
  ...
  <meta property="twitter:image" content={"https://r.moxy.social/ykZcSLKZUq/approval/twitter.png/" + path.join("/")} />
</svelte:head>
